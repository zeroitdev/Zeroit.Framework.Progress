...
using Zeroit.Framework.Progress.AnimationHelpers.AnimationEditors;
using Zeroit.Framework.Progress.AnimationHelpers.PeaceAnimator_WinformAnimation;
...
namespace Zeroit.Framework.Progress.AnimationHelpers.WinFormAnimation
{
    ...
    public partial class PeaceAnimatorWithEditor : Component
    {
        ...
        #region Private Fields
            ...
            public Zeroit.Framework.Progress.AnimationHelpers.AnimationEditors.PeaceInput peaceInput = new Zeroit.Framework.Progress.AnimationHelpers.AnimationEditors.PeaceInput(
                Zeroit.Framework.Progress.AnimationHelpers.WinFormAnimation.animationMode.OneD, false, false, 0, 100, 5000, 0,
            Zeroit.Framework.Progress.AnimationHelpers.WinFormAnimation.KnownAnimationFunctions.CircularEaseIn, "Value",
            Zeroit.Framework.Progress.AnimationHelpers.WinFormAnimation.Animator.KnownProperties.Value, true, new Zeroit.Framework.Progress.AnimationHelpers.WinFormAnimation.Animator(new Zeroit.Framework.Progress.AnimationHelpers.WinFormAnimation.Path(0, 100, 5000, 0)), 
            new Control()
            );
